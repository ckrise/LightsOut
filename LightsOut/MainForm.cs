...
namespace LightsOut
{
    ...
    {
        private const int GridOffset = 20; // Distance from upper-left side of window
        private const int GridLength = 250; // Size in pixels of grid
        ...
        private void MainForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            for (int r = 0; r < NumCells; r++)
            {
                for (int c = 0; c < NumCells; c++)
                {
                    ...
                    int y = r * CellLength + GridOffset + 5;
